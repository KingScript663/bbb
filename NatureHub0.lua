...
function Library:create_ui()
    ...
    function self:create_tab(title: string, icon: string)
        ...
        function TabManager:create_module(settings: any)
            ...
            ModuleName.TextColor3 = Color3.fromRGB(255, 80, 80)
            ...
            Description.TextColor3 = Color3.fromRGB(255, 80, 80)
            ...
            Keybind.BackgroundColor3 = Color3.fromRGB(255, 80, 80)
            ...
            function ModuleManager:create_checkbox(settings: any)
                ...
                KeybindBox.BackgroundColor3 = Color3.fromRGB(255, 80, 80)
            ...
            function ModuleManager:create_slider(settings: any)
                ...
                Drag.BackgroundColor3 = Color3.fromRGB(255, 80, 80)
                Drag.Parent = Slider
            ...
            function ModuleManager:create_feature(settings)
                ...
                if not settings.disablecheck then
                    ...
                    Checkbox.BackgroundColor3 = checked and Color3.fromRGB(255, 80, 80) or Color3.fromRGB(32, 38, 51)
                    Checkbox.Text = ""
